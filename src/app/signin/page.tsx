  ...
  return (
    <div>
      <div className=" w-full pt-28 pb-4 flex items-center justify-center ">
        <div className="w-[80%] mx-auto py-16 flex pt-28 rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-gradient-to-r from-blue-200 to-purple-200 z-10">
          <div className="hidden md:flex items-center justify-center w-1/2 h-full">
            <Image
              src={'/userRegistration/signinIllus.jpg'}
